 ...
 */
/*public*/ class ShadowlessDataPrivate {
     ...
     */
    @Keep
    private static void trackAppViewScreen(Activity activity, String eventName) {
        try {
            if (activity == null) {
                return;
            }
            ...
            ShadowlessDataAPI.getInstance().track(eventName, properties);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void registerActivityLifecycleCallbacks(Application application) {
        application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityResumed(Activity activity) {
                trackAppViewScreen(activity, "$AppPageStart");
            }

            @Override
            public void onActivityPaused(Activity activity) {
                trackAppViewScreen(activity, "$AppPageEnd");
            }
    ...
    public static Map<String, Object> getDeviceInfo(Context context) {
        final Map<String, Object> deviceInfo = new HashMap<>();
        {
            ...
            deviceInfo.put("$lib_version", ShadowlessDataAPI.SDK_VERSION);
     ...
     * @return
     */
    public static String getViewId(Context context, int id) {
        String idString = null;
        try {
            if (id != View.NO_ID) {
    ...
    public static String getElementType(View view) {
        ...
        } else if (view instanceof RadioGroup) { // RadioButton
            viewType = "RadioGroup";
